    ...
    <div className="mx-auto max-w-md px-4 py-16">
      <div className="animate-rise rounded-2xl border border-[var(--color-line)] bg-white p-6 sm:p-8">
        ...
        <p className="mt-1 text-sm text-[var(--color-muted)]">
          Build your interview flashcard deck.
        </p>
        <form onSubmit={onSubmit} className="mt-6 space-y-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full rounded-xl bg-[var(--color-copper)] py-2.5 text-sm font-semibold text-white disabled:opacity-60"
          >
        ...
        <p className="mt-5 text-center text-sm text-[var(--color-muted)]">
          ...
          <Link to="/login" className="font-semibold text-[var(--color-copper)]">
            Log in
          </Link>
        </p>
      </div>
