...
const topicsData = {
    "HTML/CSS": {
        mdFile: "HTML and CSS Overview.md",
        subtopics: [
            { name: "HTML Basics", path: "HTML_CSS/HTML_Basics" },
            { name: "CSS Fundamentals", path: "HTML_CSS/CSS_Fundamentals" },
            { name: "Layouts (Flexbox & Grid)", path: "HTML_CSS/Layouts" },
            { name: "Responsive Design", path: "HTML_CSS/Responsive_Design" },
            { name: "Examples", path: "HTML_CSS/Examples" }
        ]
    },
    "JavaScript": {
        mdFile: "JavaScript Overview.md",
        subtopics: [
            { name: "Core Concepts", path: "JavaScript/Core_Concepts" },
            { name: "DOM Manipulation", path: "JavaScript/DOM_Manipulation" },
            { name: "Asynchronous JavaScript", path: "JavaScript/Asynchronous_JavaScript" },
            { name: "Examples", path: "JavaScript/Examples" }
        ]
    },
    "PHP": {
        mdFile: "PHP Overview.md",
        subtopics: [
            { name: "PHP Syntax", path: "PHP/PHP_Syntax" },
            { name: "Form Handling", path: "PHP/Form_Handling" },
            { name: "Database with MySQL", path: "PHP/Database_MySQL" }
        ]
    }
};
...
function updateBrowserTabTitle(viewName) {
    document.title = `${viewName} | 💻 Ultimate Web Dev Repository`;
}
...
async function checkUrlHashRoute() {
    ...
    if (!currentHash) {
        document.title = "Ultimate Web Dev Repository";
        return; 
    }
