...
CORE_VIEWER_FILES = {'index.html', 'script.js', 'style.css', 'generate_manifest.py'}
def build_flat_tree(root_dir):
    ...
    for root, dirs, files in os.walk(root_dir):
        ...
        for f in files:
            # Skip core site files, dotfiles, and compiled python files.
            if f in CORE_VIEWER_FILES or f.startswith('.') or f.endswith(('.pyc', '.json')):
                continue
